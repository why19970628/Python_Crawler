# coding = utf-8
import pandas as pd
from pyecharts.charts import Bar, Pie, Geo, Liquid ,Map
...
print(df_new.site.value_counts())
...
print([list(z) for z in zip(data_985_211['name'].values.tolist(), data_985_211['counts'].values.tolist())])
# 高质量高校分布热力图
map = Map()
